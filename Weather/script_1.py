...
# Create the Weather Data Analysis Tkinter Application
...
with open('weather_analysis_app.py', 'w') as f:
    f.write(tkinter_code)

print("Weather Data Analysis Tkinter Application created successfully!")
print("\nFile: weather_analysis_app.py")
print(f"Total lines of code: {len(tkinter_code.split(chr(10)))}")
print("\nThe application includes:")
print("✓ Professional GUI with Tkinter")
print("✓ CSV file loading functionality")
print("✓ Data preview in table format")
print("✓ Statistical analysis")
print("✓ Temperature trend visualization")
print("✓ Rainfall analysis")
print("✓ Weather conditions pie chart")
print("✓ Correlation matrix heatmap")
print("✓ Status bar and error handling")
